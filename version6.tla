...
Lbl_23(self) == 
                ...
                /\ LET _network == send(_Publisher_data[self].BrokerID, [type |-> "PINGREQ", sender |-> self]) IN
                   ...
                   /\ UNCHANGED << depth, cp, activeClients, sessionClients, idtopic, RetainedMessages, pk, Topics, TopicPool, _Broker_data, _Publisher_data, _Subscriber_data, _attaque_data, _stack >>
_Publisher(self) == 
                        PubStart(self) \/ waitCONN(self) \/ tryPUBLISH(self) \/ lbl(self) \/ tryPUB1(self) \/ waitPUB1(self) \/ Lbl_23(self) \/ Lbl_1(self) \/ Lbl_2(self) \/ Lbl_3(self) \/ Lbl_4(self) \/ Lbl_5(self) \/ Lbl_6(self) \/ Lbl_7(self) \/ Lbl_8(self) \/ Lbl_9(self) \/ Lbl_10(self) \/ cqos2(self) \/ waitPUB2(self) \/ waitPUBCOMP2(self)  
Sub_start(self) == 
                   /\ _pc[self] = "Sub_start"
                   /\ cp = any
...
Disconnectsub(self) == 
                       ...
                       /\ LET _network == send(_Subscriber_data[self].BrokerID, [type |-> "DISCONNECT", sender |-> self]) IN
                          ...
                          /\ UNCHANGED << depth, cp, activeClients, sessionClients, idtopic, RetainedMessages, pk, Topics, TopicPool, _Broker_data, _Publisher_data, _Subscriber_data, _attaque_data, _stack >>
_Subscriber(self) == 
                         Sub_start(self) \/ Sub_waitCONN(self) \/ Sub_subscription(self) \/ sub0(self) \/ sub1(self) \/ Sub_waitsubscription(self) \/ Sub_listen(self) \/ unSub_subscription(self) \/ unSub_waitsubscription(self) \/ pingreq(self) \/ Disconnectsub(self) \/ Lbl_1(self) \/ Lbl_2(self) \/ Lbl_3(self) \/ Lbl_4(self) \/ Lbl_5(self) \/ Lbl_6(self) \/ Lbl_7(self) \/ Lbl_8(self) \/ Lbl_9(self) \/ Lbl_10(self) \/ cqos2(self) \/ waitPUB2(self) \/ waitPUBCOMP2(self)  
PUBACK(self) == 
                /\ _pc[self] = "PUBACK"
                /\ cp = any
                /\ \/ /\ (Len(network[_attaque_data[self].BrokerID]) > 0)
                         /\ LET packet == Head(network[_attaque_data[self].BrokerID]) IN
                            \/ /\ (packet.type = "PUBACK")
                                  /\ LET _network == [network EXCEPT ![_attaque_data[self].BrokerID] = Tail(network[_attaque_data[self].BrokerID])] IN
                                     LET __attaque_data == [_attaque_data EXCEPT ![self].OBS = TRUE] IN
                                     LET __network == send(__attaque_data[self].BrokerID, [type |-> "PUBACK", sender |-> packet.sender, topic |-> packet.topic, QoS |-> packet.QoS]) IN
                                     LET ___attaque_data == [__attaque_data EXCEPT ![self].pk = packet.sender] IN
                                     LET ____attaque_data == [___attaque_data EXCEPT ![self].INJ = TRUE] IN
                                     \/ /\ (____attaque_data[self].INJ = TRUE)
                                              /\ _pc' = [_pc EXCEPT ![self] = "Done"]
                                              /\ network' = __network
                            ...
                            \/ /\ ~((packet.type = "PUBACK"))
                                  /\ \/ /\ (_attaque_data[self].INJ = TRUE)
                                     ...
                                     \/ /\ ~((_attaque_data[self].INJ = TRUE))
                                              ...
                                              /\ UNCHANGED << depth, cp, network, activeClients, sessionClients, idtopic, RetainedMessages, pk, Topics, TopicPool, _Broker_data, _Publisher_data, _Subscriber_data, _attaque_data, _stack >>
_attaque(self) == 
                      PUBACK(self) \/ Lbl_1(self) \/ Lbl_2(self) \/ Lbl_3(self) \/ Lbl_4(self) \/ Lbl_5(self) \/ Lbl_6(self) \/ Lbl_7(self) \/ Lbl_8(self) \/ Lbl_9(self) \/ Lbl_10(self) \/ cqos2(self) \/ waitPUB2(self) \/ waitPUBCOMP2(self)  
